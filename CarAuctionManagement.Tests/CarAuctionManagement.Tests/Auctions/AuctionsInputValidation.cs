...
public class AuctionsInputValidation
{
    ...
    // {
    //     yield return new object?[] { null, new Sedan { Id = "2", Manufacturer = "Honda", Year = 2019, Model = "Civic", StartingBid = 1500.00m, NumberOfDoors = 4 }, "Id must be provided." };
    //     yield return new object?[] { "", new Hatchback { Id = "2", Manufacturer = "Honda", Year = 2019, Model = "Civic", StartingBid = 1500.00m, NumberOfDoors = 4 }, "Id must be provided." };
    ...
    // public void Validate_ShouldThrowException_WithInvalidBid(string id, string bidderId, string auctionId, decimal amount, string expectedMessage)
    // {
