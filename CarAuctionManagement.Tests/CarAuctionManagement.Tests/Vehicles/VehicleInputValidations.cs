...
public class VehicleInputValidations
{
    ...
    //     yield return new object[]
    //     {
    //         new Vehicle { Id = "1", Manufacturer = "Toyota", Year = 1800, Model = "Corolla", StartingBid = 1000.00m },
    ...
    //     yield return new object[]
    //     {
    //         new Hatchback { Id = "1", Manufacturer = "Toyota", Year = 2020, Model = "Corolla", StartingBid = 1000.00m, NumberOfDoors = 2 },
    //         "Hatchback number of doors must be greater than 3."
    //     };
    //     yield return new object[]
    //     {
    //         new Sedan { Id = "1", Manufacturer = "Toyota", Year = 2020, Model = "Corolla", StartingBid = 1000.00m, NumberOfDoors = 2 },
    //         "Sedan number of doors must be greater than 3."
    //     };
    //     yield return new object[]
    //     {
    //         new Truck { Id = "1", Manufacturer = "Toyota", Year = 2020, Model = "Corolla", StartingBid = 5000.00m, LoadCapacity = 0 },
    //         "Truck load capacity must be greater than 0."
    //     };
    //     yield return new object[]
    //     {
    //         new Truck { Id = "1", Manufacturer = "Toyota", Year = 2020, Model = "Corolla", StartingBid = 5000.00m, LoadCapacity = 999999999 },
    //         "Truck load capacity exceeds maximum limit."
    //     };
    //     yield return new object[]
    //     {
    //         new Suv { Id = "1", Manufacturer = "Toyota", Year = 2020, Model = "Corolla", StartingBid = 1000.00m, NumberOfSeats = 3 },
