...
public class VehicleServiceTests
{
    ...
    {
        var vehicle = new Hatchback { Id = Guid.NewGuid(), Manufacturer = "Toyota", Year = 2020, Model = "Corolla", StartingBid = 1000.00m, NumberOfDoors = 5 };
    ...
    [InlineData("d3b07384-d9a1-4d3b-8a1d-6b1d1e1d1e1d", typeof(CustomExceptions.VehicleAlreadyExistsException), "Vehicle with ID d3b07384-d9a1-4d3b-8a1d-6b1d1e1d1e1d already exists on the inventory.")]
    public void AddVehicle_ShouldThrowException_WhenInvalid(string? id, Type expectedExceptionType, string expectedMessage)
    {
        var vehicle = id == null ? null : new Hatchback { Id = Guid.Parse(id), Manufacturer = "Toyota", Year = 2020, Model = "Corolla", StartingBid = 1000.00m, NumberOfDoors = 5 };
        if (id != null)
        {
    ...
    [Theory]
    [InlineData("d3b07384-d9a1-4d3b-8a1d-6b1d1e1d1e1d", true)]
    [InlineData("d3b07384-d9a1-4d3b-8a1d-6b1d1e1d1e1d", false)]
    public void GetVehicleById_ShouldReturnCorrectResult(string id, bool shouldExist)
    {
        var vehicle = shouldExist
            ? new Truck
            {
                Id = Guid.Parse(id),
                Manufacturer = "Toyota",
        ...
        if (shouldExist)
        {
            var result = _service.GetVehicleById(Guid.Parse(id));
            Assert.NotNull(result);
            Assert.Equal(Guid.Parse(id), result.Id);
        }
        else
        {
            var exception = Assert.Throws<CustomExceptions.VehicleNotFoundException>(() => _service.GetVehicleById(Guid.Parse(id)));
    ...
    public void GetVehicleById_ShouldThrowException_WhenNoVehiclesFound()
    {
        ...
        var exception = Assert.Throws<CustomExceptions.NoVehiclesFoundException>(() => _service.GetVehicleById(Guid.NewGuid()));
        Assert.Equal("No vehicles found in the inventory.", exception.Message);
    }
    ...
    public void GetVehicles_ShouldReturnListOfVehicles_WhenVehiclesExist()
    {
        var vehicles = new List<Vehicle?>
        {
            new Hatchback { Id = Guid.NewGuid(), Manufacturer = "Toyota", Year = 2020, Model = "Corolla", StartingBid = 1000.00m, NumberOfDoors = 5 },
            new Sedan { Id = Guid.NewGuid(), Manufacturer = "Honda", Year = 2019, Model = "Civic", StartingBid = 1500.00m, NumberOfDoors = 4 },
            new Truck { Id = Guid.NewGuid(), Manufacturer = "Honda", Year = 2010, Model = "Glober", StartingBid = 2000.00m, LoadCapacity = 500 },
            new Suv { Id = Guid.NewGuid(), Manufacturer = "Fiat", Year = 1999, Model = "Panda", StartingBid = 500.00m, NumberOfSeats = 5 }
        };
    ...
    public void GetVehicleSearch_ShouldReturnFilteredVehicles(string type, string manufacturer, string model, int? year, int expectedCount)
    {
        var vehicles = new List<Vehicle?>
        {
            new Sedan { Id = Guid.NewGuid(), Manufacturer = "Toyota", Year = 2020, Model = "Camry", StartingBid = 1000.00m, NumberOfDoors = 4 },
            new Hatchback { Id = Guid.NewGuid(), Manufacturer = "Honda", Year = 2019, Model = "Civic", StartingBid = 900.00m, NumberOfDoors = 5 },
            new Hatchback { Id = Guid.NewGuid(), Manufacturer = "Honda", Year = 2010, Model = "M3", StartingBid = 2000.00m, NumberOfDoors = 3 },
            new Suv { Id = Guid.NewGuid(), Manufacturer = "Honda", Year = 1999, Model = "Jazz", StartingBid = 500.00m, NumberOfSeats = 5 }
        };
    ...
    public void UpdateVehicle_ShouldUpdateVehicleDetails_WhenVehicleExists()
    {
        ...
        var existingVehicle = new Sedan { Id = vehicleId, Manufacturer = "Toyota", Year = 2020, Model = "Camry", StartingBid = 1000.00m, NumberOfDoors = 4 };
        var updatedVehicle = new Sedan { Id = vehicleId, Manufacturer = "Toyota", Year = 2021, Model = "Blob", StartingBid = 1000.00m, NumberOfDoors = 4 };
    ...
    {
        var updatedVehicle = new Sedan { Id = Guid.NewGuid(), Manufacturer = "Toyota", Year = 2021, Model = "Camry", StartingBid = 1200.00m, NumberOfDoors = 4 };

        _mockRepository.Setup(r => r.GetVehicles()).Returns(new List<Vehicle?>());

        var exception = Assert.Throws<CustomExceptions.VehicleNotFoundException>(() => _service.UpdateVehicle(updatedVehicle));
        Assert.Equal($"Vehicle with ID {updatedVehicle.Id} not found.", exception.Message);
    }
    ...
    {
        Guid vehicleId = Guid.NewGuid();
        var existingVehicle = new Suv { Id = vehicleId, Manufacturer = "Toyota", Year = 2020, Model = "RAV4", StartingBid = 1000.00m, NumberOfSeats = 5 };
        var updatedVehicle = new Truck { Id = vehicleId, Manufacturer = "Toyota", Year = 2021, Model = "RAV4", StartingBid = 1200.00m, LoadCapacity = 7 };
        var vehicles = new List<Vehicle?> { existingVehicle };
    ...
    {
        var vehicle = new Hatchback { Id = Guid.NewGuid(), Manufacturer = "Opel", Year = 2000, Model = "Polo", StartingBid = 1500.00m, NumberOfDoors = 4 };
        ...
        _service.RemoveVehicle(vehicle.Id);

        _mockRepository.Verify(r => r.RemoveVehicle(It.Is<Vehicle>(v => v.Id == vehicle.Id)), Times.Once);
    ...
    public void RemoveVehicle_ShouldThrowException_WhenVehicleDoesNotExist()
    {
        ...
        var exception = Assert.Throws<CustomExceptions.NoVehiclesFoundException>(() => _service.RemoveVehicle(Guid.NewGuid()));
        Assert.Equal("No vehicles found in the inventory.", exception.Message);
    }
    ...
    {
        var vehicle = new Hatchback { Id = Guid.NewGuid(), Manufacturer = "Opel", Year = 2000, Model = "Polo", StartingBid = 1500.00m, NumberOfDoors = 4 };
        var vehicleRemoved = new Hatchback { Id = Guid.NewGuid(), Manufacturer = "Opel", Year = 2000, Model = "Polo", StartingBid = 1500.00m, NumberOfDoors = 4 };
        _mockRepository.Setup(r => r.GetVehicles()).Returns(new List<Vehicle?> { vehicle });

        var exception = Assert.Throws<CustomExceptions.VehicleNotFoundException>(() => _service.RemoveVehicle(vehicleRemoved.Id));
        Assert.Equal($"Vehicle with ID {vehicleRemoved.Id} not found.", exception.Message);
    }
}